...
Run the draft against the refusal list in `docs/brand-system.md` section 10. Report as a short list: rule number, what failed, the fix. If nothing fails, say so in one line.
